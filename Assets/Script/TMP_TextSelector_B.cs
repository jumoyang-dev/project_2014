...
namespace TMPro.Examples
{
    ...
    public class TMP_TextSelector_B : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler, IPointerUpHandler
    {
        ...
        void Awake()
        {
            ...
            m_Canvas = GameObject.FindGameObjectWithTag("MainCanvas").GetComponent< Canvas>();
            ...
            if (isHoveringObject)
            {
                ...
                if (m_TextPopup_RectTransform != null && m_selectedWord != -1 && (wordIndex == -1 || wordIndex != m_selectedWord))
                {
                    ...
                    for (int i = 0; i < wInfo.characterCount; i++)
                    {
                        ...
                        Color32 c = vertexColors[vertexIndex + 0].Tint(1.333333f);
                ...
                if (linkIndex != -1 && linkIndex != m_selectedLink)
                {
                    ...
                    switch (linkInfo.GetLinkID())
                    {
                        case "id_01": // 100041637: // id_01
                            ...
                            m_TextPopup_TMPComponent.text = "The only superstate. The greatest state. MY state.";
                            break;

                        case "id_02": // 100041638: // id_02

                            m_TextPopup_TMPComponent.text = "We say that they were removed from the map in 2006. We say that the rest of them escaped to the Moon. ";
                            break;

                        case "id_03": // 100041638: // id_02

                            m_TextPopup_TMPComponent.text = "We say that they were removed from the map in 2010. We say that none of them are left.";
                            break;

                        case "id_04": // 100041638: // id_02

                            m_TextPopup_TMPComponent.text = "This is the name they love. This is the name they fear. This is me.";
                            break;
                            
                        case "id_05": // 100041638: // id_02

                            m_TextPopup_TMPComponent.text = "I tell them to question. I tell them to torture.I tell them to kill.";
                            break;
                        case "id_06": // 100041638: // id_02

                            m_TextPopup_TMPComponent.text = "They serve to protect.They serve to evolve. They serve to war.";
                            break;
                        case "id_07": // 100041638: // id_02

                            m_TextPopup_TMPComponent.text = "They should build. They should give.They should take.";
                            break;
                        case "id_08": // 100041638: // id_02

                            m_TextPopup_TMPComponent.text = "I tell them what to tell.I tell them what to know. They tell them what to believe.";
                            break;
                        case "id_09": // 100041638: // id_02

                            m_TextPopup_TMPComponent.text = "Territories of Oceania before Eurasia and Eastasia were wiped out. Airstrip One is where I, the center of the entire nation, sits.";
                            break;
                        case "id_10": // 100041638: // id_02

                            m_TextPopup_TMPComponent.text = " Territories claimed after the defeat of Eurasia and Eastasia. The weak will always give back what they do not deserve in the end.";
                            break;
                        case "id_11": // 100041638: // id_02

                            m_TextPopup_TMPComponent.text = "Useless, weak, stupid, dull animals living outside of the Party parameters. There are just too many of them.";
                            break;
                        case "id_12": // 100041638: // id_02

                            m_TextPopup_TMPComponent.text = "They’ve all got one each. I can see all of them through it. I can hear all of them through it. I can catch all of them through it. ";
                            break;
                        case "id_13": // 100041638: // id_02

                            m_TextPopup_TMPComponent.text = "The new thing Darwin is working on. He tells me it generates some form of virtual reality where literally anything could be simulated, even pain.";
                            break;

                        case "id_14": // 100041638: // id_02

                            m_TextPopup_TMPComponent.text = "The primary and only method for reproduction of all Party members. What I fancy about this thing is that it analyzes all variables’ genes and picks the best combinations out of all the variables. ";
                            break;

                        case "id_15": // 100041638: // id_02
